...
/singleton/poster/fleet
	...
	name = "UGNF recruitment poster"
	desc = "A poster produced by the UGNF. It depicts a tactical-looking Fourth Fleet petty officer, standing in front of the UGN flag proudly."
