...
/obj/item/clothing/suit/storage/solgov/service/expeditionary
	...
	desc = "A uniform service jacket belonging to the UGN Expeditionary Corps."
...
/obj/item/clothing/suit/solgov/fleet_sweater/flag
	...
	desc = "A navy blue UGN Fleet serivce sweater with red accents."
...
/obj/item/clothing/suit/storage/solgov/dress/expedition
	...
	desc = "A silver and black dress peacoat belonging to the UGN Expeditionary Corps. Fashionable, for the 25th century at least."
	icon_state = "ecdress_xpl"
	item_state = "ecdress_xpl"
...
/obj/item/clothing/suit/storage/solgov/dress/expedition/command
	...
	desc = "A gold and black dress peacoat belonging to the UGN Expeditionary Corps. The height of fashion."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet
	...
	desc = "A navy blue UGN Fleet dress jacket. Don't get near pasta sauce or vox."
	icon_state = "whitedress"
	item_state = "whitedress"

/obj/item/clothing/suit/storage/solgov/dress/fleet/snco
	name = "fleet dress SNCO jacket"
	desc = "A navy blue UGN Fleet dress jacket with silver cuffs. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/officer
	...
	desc = "A navy blue UGN Fleet dress jacket with silver accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/command
	...
	desc = "A navy blue UGN Fleet dress jacket with gold accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/flag
	...
	desc = "A navy blue UGN Fleet dress jacket with red accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/dress/solgov/fleet/sailor
	...
	desc = "A navy blue UGN Fleet dress suit. Almost looks like a school-girl outfit."
...
/obj/item/clothing/suit/space/void/command
	...
	desc = "A light, radiation resistant voidsuit commonly used among UGN uniformed services. This one has an EC seal on its chest plate and command department markings."
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')
