/datum/uplink_item/item/visible_weapons/m22f
	name = "Service Pistol, UGN, Heavy"
	desc = "A Hephaestus Industries M22F. A large pistol issued as an UGNDF service weapon."
	item_cost = 40
	path = /obj/item/gun/projectile/pistol/m22f


/datum/uplink_item/item/visible_weapons/m19
	name = "Service Pistol, UGN, Light"
	desc = "A Hephaestus Industries M19. A light pistol issued as an UGNDF service weapon."
	item_cost = 32
